...
def add_entry():
    ...
    otvet = []
    text = []
    for papka in os.listdir('/home/lexix/database/database2')[1:]:
        for name in os.listdir('/home/lexix/database/database2/%s'%papka):
            otvet.append(papka)
            text.append(codecs.open('/home/lexix/database/database2/%s/%s'%(papka,name),'r').read().decode('koi8_r'))
